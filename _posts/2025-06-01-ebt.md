...
TODO add paper link [^1]

**TLDR**: We **outscale** (feed-forward) transformers while **generalizing** reasoning/system 2 thinking to any modality/problem 😮.

<!-- ![Comparison of EBWM to Existing Autoregressive Approaches](/assets/img/blog/ebwm_comparison.png) -->
<img src="/assets/img/blog/ebwm_comparison.png" alt="Comparison of EBWM to Existing Autoregressive Approaches" width="1000" />
...
[^1]: The old version of this paper was called "Cognitively-Inspired Energy Based World Models" but because of me starting my PhD, working with other people, along some other things, we thought a rebrand was fitting. We also conducted many more thorough experiments due to having additional computation.
